...
-- Save with Ctrl + S like Windows
vim.keymap.set('n', '<C-s>', ':w<CR>', { noremap = true, silent = true, desc = 'Save/Write' })
vim.keymap.set('i', '<C-s>', '<Esc>:w<CR>a', { noremap = true, silent = true, desc = 'Save/Write' })
...
-- Always edit with the stupid swap file warning
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Setup bufferline to show tabs instead of buffers
